...
# ----------------------------------------
register(
    id="GazeboRobotinoTrainEnv-v0",
    entry_point="gym.envs.robotino:GazeboRobotinoTrainEnv",
)

register(
    id="GazeboRobotinoTestEnv-v0",
    entry_point="gym.envs.robotino:GazeboRobotinoTestEnv",
)
