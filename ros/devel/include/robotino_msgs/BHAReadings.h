...
struct BHAReadings_
{
  ...
  _stamp_type stamp;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _pressures_type;
  _pressures_type pressures;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _cablepull_type;
...
bool operator==(const ::robotino_msgs::BHAReadings_<ContainerAllocator1> & lhs, const ::robotino_msgs::BHAReadings_<ContainerAllocator2> & rhs)
{
